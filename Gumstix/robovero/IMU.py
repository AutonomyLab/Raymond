...
while True:
  ...
  #cx=twosComplement(compassdata[1], compassdata[0]) #/1055.0,
  #cy=twosComplement(compassdata[3], compassdata[2]) #/1055.0,
  #cz=twosComplement(compassdata[5], compassdata[4]) #/950.0
  #print cx, cy, cz, '\t\t'
  #heading = degrees(atan2(cx,-cy))
  #print heading
